...
namespace SampleDesktop
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var credentials = LoadCredentials(userName);
        ...
        static AuthCredential LoadCredentials(string userName)
        {
        ...
        static string GetAppDataPath(string userName)
        {
            var path = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "Fitbit", userName);
